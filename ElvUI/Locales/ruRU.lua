...
L["Show BG Texts"] = "Показать фоновые тексты"
...
L["You still have ElvUI_Config installed. ElvUI_Config has been renamed to ElvUI_OptionsUI, please remove it."] = "У вас все еще установлен ElvUI_Config. ElvUI_Config был переименован в ElvUI_OptionsUI, удалите его."
