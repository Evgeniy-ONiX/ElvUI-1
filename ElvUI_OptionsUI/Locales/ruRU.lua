...
L["Add a Name to the list."] = "Добавьте имя в список."
...
L["Ammo Pouch"] = "Подсумок для боеприпасов"
...
L["Arena Frame"] = "Окно арены"
L["Arena Registrar"] = "Регистратор арены"
L["Arena"] = "Арена"
L["Arrow Size"] = "Размер стрелки"
L["Arrow X-Offset"] = "Стрелка смещение по X"
L["Arrow Y-Offset"] = "Стрелка смещение по Y"
...
L["Bag Spacing"] = "Расстояние между сумками"
L["Bag"] = "Сумка"
...
L["Change the width and controls how big of an area on the screen will accept clicks to target unit."] = "Измените ширину и контролируйте, насколько большая область на экране будет принимать клики для целевого юнита."
...
L["Controls how many seconds of inactivity has to pass before chat is faded."] = "Определяет, сколько секунд бездействия должно пройти, прежде чем чат исчезнет."
L["Cooldown Orientation"] = "Ориентация перезарядки"
...
L["Current"] = "Текущее"
L["Curse Effect"] = "Эффект проклятия"
...
L["Disease Effect"] = "Эффект болезни"
...
L["Display an exclamation mark on items that starts a quest."] = "Отображать восклицательный знак на предметах, с которых начинается квест."
...
L["Display reminder bar on the minimap."] = "Отображение панели напоминаний на миникарте."
...
L["Displayed server time."] = "Отображать время сервера."
...
L["Display Types"] = "Тип отображения"
...
L["Down"] = "Вниз"
L["Dropdown CheckBox Skin"] = "Скин выпадающего флажка"
...
L["Editbox History Size"] = "Размер истории окна редактирования"
...
L["Enemy NPC Frames"] = "Рамки вражеских NPC"
L["Enemy Player Frames"] = "Рамки вражеских игроков"
L["Enemy"] = "Враг"
L["Engineering"] = "Инженерия"
L["Enhanced PVP Messages"] = "Улучшенные PvP сообщения"
L["Equipped Item Color"] = "Цвет экипированного предмета"
...
L["Fade Chat Toggles"] = "Исчезающие переключатели чата"
...
L["Fader"] = "Затухание"
L["Fades the buttons that toggle chat windows when that window has been toggled off."] = "Затемняет кнопки, которые переключают окна чата, когда это окно было выключено."
...
L["Flyout Spacing"] = "Интервал всплывающего окна"
L["Focus"] = "Фокус"
...
L["Friendly NPC Frames"] = "Рамки дружественных NPC"
L["Friendly Player Frames"] = "Рамки дружественных игроков"
...
L["If enabled then the filter will activate if the unit is casting anything."] = "Если этот параметр включен, то фильтр будет активироваться, если юнит что-либо разыгрывает."
L["If enabled then the filter will activate if the unit is channeling anything."] = "Если включено, то фильтр активируется, если юнита что-то направляет."
L["If enabled then the filter will activate if the unit is not casting anything."] = "Если включено, то фильтр активируется, если юнит ничего не использует."
L["If enabled then the filter will activate if the unit is not channeling anything."] = "Если включено, то фильтр активируется, если юнита ничего не направляет."
...
L["If enabled then the filter will only activate when you have a target."] = "Если этот параметр включен, фильтр будет активироваться только тогда, когда у вас есть цель."
...
L["No Duration"] = "Нет продолжительности"
...
L["Pick Up Action Key"] = "Подобрать кнопку действия"
...
L["Reset Editbox History"] = "Сбросить историю редактирования"
...
L["Reverse Cooldown"] = "Обратный кулдаун"
...
L["Selector Color"] = "Выбор цвета"
L["Selector Style"] = "Выбор стиля"
...
L["Show Quest Icon"] = "Показать значок задания"
...
L["Text Fade"] = "Исчезновение текста"
...
L["Transparent Backdrops"] = "Прозрачные фоны"
...
L["Watch Frame"] = "Отображать список"
...
L["World State Frame"] = "Рамка статуса мира"
